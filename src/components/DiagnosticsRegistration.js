...
const DiagnosticRegistry = () => {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      // Save diagnostic profile to Supabase
      const { error: supabaseError } = await supabase
        .from("diagnostics")
        .insert([{
          hh_number: hhNumber,
          wallet_address: diagnosticAddress,
      ...
      if (supabaseError) {
        ...
        console.log("✅ Diagnostic data saved to Supabase");
      }
  ...
  return (
    <div>
    <NavBar></NavBar>
    <div className="createehr min-h-screen flex items-center justify-center p-4 bg-gradient-to-b from-black to-gray-800 font-[Times_New_Roman]">
